  ...
  return (
    <div className="min-h-screen bg-[#fffdfa]">
      <header className="fixed top-0 left-0 right-0 bg-white z-20 shadow-sm">
        <div className="max-w-screen-2xl mx-auto px-4 py-4 md:px-8 lg:px-12">
          <div className="flex items-center justify-between">
            <div className="flex-shrink-0">
              <a href="/">
                <svg className="icon icon-logo-mortgage" height="31px" role="img" version="1.1" viewBox="0 0 62 31" width="67px" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="w-full bg-[#e8eae6] h-1">
          <div className="h-full bg-[#017848] w-0"></div>
        </div>
      </header>

      <div className="fixed right-1/2 top-12 z-20">
        <div className="relative">
          <div className="w-12 h-12 rounded-full border-4 border-[#1ee07f] shadow-xl overflow-hidden">
            <img 

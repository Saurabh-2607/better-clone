...
const Footer = () => {
    const betterCompanies = [
        {
            ...
            href: '/',
            logo: 'https://media.better.com/better-com/1660240096238/better-mortgage-logo.svg',
        ...
        },
        {
            ...
            href: '/',
            logo: 'https://media.better.com/better-com/1660240096238/better-real-estate-logo.svg',
        ...
        },
        {
            name: 'Better Cover',
            href: '/',
            logo: 'https://media.better.com/better-com/1660240096238/better-cover-logo.svg',
        ...
        },
        {
            name: 'Better Inspect',
            href: '/',
            logo: 'https://media.better.com/better-com/1660240096238/better-inspect-logo.svg',
        ...
        {
            name: 'Better Settlement Services',
            href: '/',
            logo: 'https://media.better.com/better-com/1660240096238/better-settlement-services-logo.svg',
    ...
    const resources = [
        { title: 'Home affordability calculator', href: '/' },
        { title: 'Mortgage calculator', href: '/' },
        { title: 'Free mortgage calculator', href: '/' },
        { title: 'Mortgage calculator with taxes', href: '/' },
        { title: 'Mortgage calculator with PMI', href: '/' },
        { title: 'Rent vs buy calculator', href: '/' },
        { title: 'HELOC payment calculator', href: '/' },
        { title: 'HELOC vs cash-out refinance calculator', href: '/' },
        { title: 'Buy a home', href: '/' },
        { title: 'Sell a home', href: '/' },
        { title: 'Get home inspection', href: '/' }
    ]
    ...
    const contact = [
        { title: 'hello@better.com', href: '/' },
        { title: '415-523-8837', href: '/' },
        { title: 'FAQ', href: '/' },
        { title: 'Glossary', href: '/' }
    ]

    const legal = [
        { title: 'NMLS Consumer Access', href: '/' },
        { title: 'Privacy Policy', href: '/' },
        { title: 'Terms of Use', href: '/' },
        { title: 'Disclosures & Licensing', href: '/' },
        { title: 'Affiliated Business', href: '/' },
        { title: 'Browser Disclaimer', href: '/' }
    ]
    ...
    const legalDisclosures = [
        ...
        },
        {
            ...
            link: { text: 'One Day Heloc™ Terms and Conditions.', href: '/' }
        },
        {
            id: 3,
            text: 'Assumes borrowers are eligible for the Automated Valuation Model (AVM) to calculate their home value, their loan amount is less than $400,000, all required documents are uploaded to their Better Mortgage online account within 24 hours of application, closing is scheduled for the earliest available date and time, and a notary is readily available. Funding timelines may vary and may be longer if an appraisal is required to calculate a borrower\'s home value.'
        }
    ]

    return (
        <footer className="bg-white">
            <div className="mx-auto px-6 py-6 md:px-10 lg:px-16 xl:px-20 2xl:px-40">
                ...
                <div className="mt-6 flex flex-col gap-y-8 md:flex-row md:gap-16">
                    ...
                    <div className="flex-shrink flex-grow basis-1/6">
                        ...
                        <ul className="mt-6 space-y-4">
                            {betterCompanies.map((company, index) => (
                ...
                <div className="mt-12">
                    {legalDisclosures.map((disclosure) => (
                        <p key={disclosure.id} className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-xs">
                            <sup>{disclosure.id}</sup> {disclosure.text}
                            {disclosure.link && (
                                <a 
                    ...
                    <p className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-xs mt-4">
                        ...
                        <a className="font-normal underline focus:outline-interactivePrimary focus:outline-1 focus:outline-offset-[theme(spacing.2xs)] hover:text-interactivePrimary text-inherit" data-qa="nmls-link" href="/">
                    ...
                    <p className="font-normal leading-body m-0 p-0 text-left text-textPrimary text-xs mt-4">
                        ...
                        <a className="font-normal underline focus:outline-interactivePrimary focus:outline-1 focus:outline-offset-[theme(spacing.2xs)] hover:text-interactivePrimary text-inherit" href="/">
                            license numbers
                        </a>

...
const StartForm = () => {
  ...
  const options = [
    {
      ...
      title: 'Buying a home',
      icon: (
        <svg height="36" stroke="none" viewBox="0 0 36 36" width="36" fill="#017848">
          <path d="M35.579 13.748 18.703.247a1.124 1.124 0 0 0-1.406 0L.42 13.747a1.125 1.125 0 0 0 .698 2.003h2.25v19.126A1.126 1.126 0 0 0 4.494 36h27.001a1.125 1.125 0 0 0 1.125-1.125V15.75h2.25a1.125 1.125 0 0 0 .709-2.002Zm-4.084-.248a1.125 1.125 0 0 0-1.125 1.125V33.75H5.619V14.625A1.126 1.126 0 0 0 4.494 13.5h-.169l13.67-10.936L31.662 13.5h-.168Z" />
    ...
    },
    {
      ...
      icon: (
        <svg height="36" stroke="none" viewBox="0 0 36 36" width="36" fill="#017848">
          <path d="M2.25 18a15.75 15.75 0 0 1 31.5 0H36a18 18 0 1 0-18 18v-2.25A15.75 15.75 0 0 1 2.25 18Z" />
  ...
  const benefits = [
    { 
      ...
      icon: (
        <svg height="22px" width="22px" viewBox="0 0 20 20" fill="#017848">
          <path clipRule="evenodd" d="M10 .833C4.94.833.833 4.94.833 10S4.94 19.166 10 19.166 19.167 15.06 19.167 10C19.167 4.94 15.06.833 10 .833Zm0 16.5c-4.042 0-7.333-3.29-7.333-7.333S5.957 2.666 10 2.666 17.333 5.957 17.333 10c0 4.042-3.29 7.333-7.333 7.333ZM7.458 15H5.5l7.057-10h1.958L7.458 15ZM7 9.476a1.71 1.71 0 0 0 1.716-1.738C8.716 6.748 7.946 6 7 6c-.968 0-1.738.748-1.738 1.738S6.032 9.476 7 9.476Zm6 4.5a1.71 1.71 0 0 0 1.716-1.738c0-.99-.77-1.738-1.716-1.738-.968 0-1.738.748-1.738 1.738s.77 1.738 1.738 1.738Z" fillRule="evenodd" />
        </svg>
      )
    },
    { 
      ...
      icon: (
        <svg height="22px" width="22px" viewBox="0 0 24 24" fill="#017848">
  ...
  return (
    <div className="bg-[#fffdfa] py-12">
      <div className="max-w-2xl mx-auto px-6">
        <div className="text-center mb-8">
          <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold text-[#292b29] mb-4 leading-tight">
            <span className="whitespace-nowrap">Hi, I'm Betsy!</span>
            <br />
        ...
        <div className="space-y-4 mb-8">
          {options.map((option) => (
            <button
              ...
              className={`w-full flex items-center justify-between p-6 border rounded-lg transition-all duration-300 text-left ${
                selectedOption === option.id
                  ? 'border-transparent shadow-[0_0_0_4px_#017848_inset] text-[#017848]'
                  : 'border-[#a4a8a4] hover:border-transparent hover:shadow-[0_0_0_4px_#017848_inset] hover:text-[#017848]'
              }`}
            >
              ...
              <div className={`transition-all duration-300 ${
                selectedOption === option.id ? 'opacity-100 w-6' : 'opacity-0 w-0'
              }`}>
                <svg height="18px" width="18px" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M8.35588 16.0296L3.61455 11.2882L2 12.8914L8.35588 19.2473L22 5.60318L20.3968 4L8.35588 16.0296Z" />
                </svg>
              </div>
            </button>
          ))}
        ...
        <div className="flex justify-between mb-8 text-center">
          {stats.map((stat, index) => (
            <div key={index} className="flex-1">
              <p className="text-3xl font-bold text-[#292b29] mb-1">{stat.value}</p>
              <p className="text-sm text-[#565d5a]">{stat.description}</p>
            </div>
          ))}
        </div>

        <div className="bg-[#f0f7f1] rounded-lg p-6 text-center">
          <p className="text-[#565d5a] mb-4">After a few questions, you'll unlock:</p>
          <div className="space-y-3">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-center">
                ...
                <p className="text-[#565d5a] text-left">{benefit.text}</p>
              </div>
            ))}
          </div>
        </div>

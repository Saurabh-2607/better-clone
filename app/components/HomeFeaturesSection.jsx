...
const HomeFeaturesSection = () => {
    ...
    const testimonials = {
        Paul: {
            name: 'Paul',
            image: 'https://media.better.com/better-com/homepage/social-proof/still-quote-Paul.webp',
            alt: 'Paul-thumbnail'
        },
        Amanda: {
            name: 'Amanda', 
            image: 'https://media.better.com/better-com/homepage/social-proof/still-quote-Amanda.webp',
            alt: 'Amanda-thumbnail'
        },
        Tiara: {
            name: 'Tiara',
            image: 'https://media.better.com/better-com/homepage/social-proof/still-quote-Tiara.webp', 
            alt: 'Tiara-thumbnail'
        }
    }
    ...
    const productCards = [
        ...
        },
        {
            ...
            href: '/',
            image: 'https://media.better.com/better-com/homepage/learning-center/one-day-mortgage.webp',
    ...
    return (
        <div className="bg-gray-50 relative">
            <div className="fixed bottom-4 right-4 cursor-pointer rounded-lg border-none z-50 hidden md:block transition-all duration-300 ease-in-out max-w-xs">
                    ...
                    <div className="flex items-center cursor-pointer md:w-72 md:shadow-md rounded-lg p-4 md:p-0 md:rounded-lg">
                        <div className="w-[30%] relative max-w-24">
                            ...
                            <div className="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]">
                                <p className="text-base text-white font-bold">Better Forever</p>
                            </div>
                        </div>
                        <div className="flex-1 p-3 md:bg-green-100 rounded-r-lg">
                            <p className="text-sm text-gray-800">Save on future home loans with $0 origination fees.</p>
            ...
            <div className="block md:hidden">
                <div className="fixed bottom-0 flex justify-center items-end w-full shadow-lg z-[9999]">
                    <div className="bg-white rounded-t-2xl w-full p-2 shadow-lg">
                        <div className="w-12 h-1 bg-gray-300 rounded-full mx-auto mb-3"></div>
                        <div className="flex items-center cursor-pointer rounded-lg p-4">
                            <div className="w-[30%] relative max-w-24">
                                <img 
                                    alt="Better Forever" 
                                    loading="lazy" 
            ...
            <section className="mx-auto flex max-w-screen-2xl flex-col justify-between gap-5 p-6 px-8 py-20 md:px-15 md:flex-row-reverse">
                <div className="flex flex-col justify-center md:max-w-[507px]">
                    <h2 className="font-bold text-gray-900 text-3xl md:text-7xl mb-8 tracking-tight">
                        Find out why we're better.
                    </h2>
                    <a 
                        className="inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal transition-all ease-in-out duration-200 bg-[#004733] text-white hover:bg-[#017848] h-16 px-12 py-5 mb-4 w-full md:w-fit" 
                        href="/"
                    >
                        See all our stories
                    </a>
                    <div className="mb-8 flex items-end justify-center gap-2 text-sm text-gray-600 md:justify-start">
                ...
                <div className="flex flex-col gap-8 md:flex-col-reverse">
                    <div className="flex gap-4 overflow-scroll [&::-webkit-scrollbar]:hidden">
                        {Object.keys(testimonials).map((name) => (
                            <button
                                key={name}
                                onClick={() => setActiveTestimonial(name)}
                                className={`inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal transition-all ease-in-out duration-200 border h-12 px-6 py-3 w-auto ${
                                    activeTestimonial === name
                                        ? 'shadow-green-200 border-green-300 shadow-[0_0_0_4px_inset] text-green-600'
                                        : 'border-gray-300 text-gray-800 hover:shadow-green-200 hover:border-green-300 hover:shadow-[0_0_0_4px_inset] hover:text-green-600'
                                }`}
                            >
                                {name}
                            </button>
                    ...
                    <div className="relative flex justify-center overflow-hidden rounded-lg w-[341px] h-[606px]">
                        <button className="relative w-full h-full" aria-label={`Play video for ${activeTestimonial}`}>
                            <img 
            ...
            <section className="w-full pb-4 lg:pb-12">
                <div className="mx-auto flex max-w-screen-2xl flex-col items-center md:items-start gap-8 px-6 py-20 md:px-10 lg:gap-[60px]">
                    <div className="flex w-full max-w-lg flex-wrap gap-12 lg:gap-6 lg:max-w-none lg:items-end lg:justify-between">
                        <h2 className="font-bold text-gray-900 text-3xl md:text-2xl md:tracking-tight w-full max-w-lg tracking-tight">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                        <a
                            className="flex cursor-pointer flex-col gap-6 rounded-lg bg-[#f0f7f1] p-6   transition-shadow duration-300"
                            href={productCards[0].href}
                        >
                        ...
                        <a
                            className="flex cursor-pointer flex-col gap-6 rounded-lg bg-[#f0f7f1] p-8   transition-shadow duration-300 md:col-span-2"
                            href={productCards[1].href}
                        >
                        ...
                        >
                            ...
                            <img 
                                alt={productCards[3].alt}
                                loading="lazy" 
                                width="300" 
                                height="200" 
                                decoding="async" 
                                className="w-full rounded-lg object-cover h-[200px]" 
                                src={productCards[3].image}
                            />
                        </a>
                    </div>
                </div>
            ...
            <hr className="border-t border-gray-200 my-0 pb-8" />
        </div>
    )
}
